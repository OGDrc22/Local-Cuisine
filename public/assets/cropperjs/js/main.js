...
!function(t, e) {
    ...
    function s(i, t, a, e) {
        ...
        t.trim().split(Ot).forEach(function(t) {
            var e;
            Tt || (e = i.listeners) && e[t] && e[t][a] && (o = e[t][a],
            delete e[t][a],
    ...
    function R(t, e) {
        var i, a = t.aspectRatio, n = t.height, t = t.width, e = 1 < arguments.length && void 0 !== e ? e : "contain", o = gt(t), h = gt(n);
        return o && h ? (i = n * a,
    ...
    var t = {
        ...
        resetPreview: function() {
            z(this.previews, function(e) {
                ...
                if (o(i[e]))
                    ...
                    i.removeAttribute("data-".concat(Ct(e)))
            })
        },
        preview: function() {
      ...
      , Rt = {
        ...
        dblclick: function() {
            var t, e;
            this.disabled || this.options.dragMode === J || this.setDragMode((t = this.dragBox,
            e = $,
      ...
      , At = {
        ...
        getCroppedCanvas: function() {
            ...
            f.drawImage.apply(f, [u].concat(j(g.map(function(t) {
                return Math.floor(Y(t))
            })))),
            f.restore(),
            t = w,
            this.cropped ? (e = (v = this.getData()).x,
            i = v.y,
            a = v.width,
            n = v.height,
            ...
            p.drawImage.apply(p, [t].concat(j(B.map(function(t) {
                return Math.floor(Y(t))
            })))),
            l) : t) : null
        },
        setAspectRatio: function(t) {
            var e = this.options;
            return this.disabled || ft(t) || (e.aspectRatio = Math.max(0, t) || NaN,
        ...
        setDragMode: function(t) {
            ...
            return this.ready && !this.disabled && (i = a.movable && t === F,
      ...
      , Pt = function() {
        ...
        (e = [{
            ...
            value: function(t) {
                ...
                i.checkOrientation && window.ArrayBuffer ? dt.test(t) ? lt.test(t) ? this.read((h = (h = t).replace(Yt, ""),
                a = atob(h),
            ...
            value: function() {
                var t = this.element
                  ...
                  , i = t.crossOrigin
                  , a = e
                  , n = (this.options.checkCrossOrigin && Nt(e) && (i = i || "anonymous",
                a = Lt(e)),
                this.crossOrigin = i,
    ...
    return g(Pt.prototype, t, i, e, Rt, St, At),
    Pt
});
