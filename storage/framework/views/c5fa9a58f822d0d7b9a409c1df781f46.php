...
<head>
    ...
    <link href="<?php echo e(asset('assets/css/loginregister.css')); ?>" rel="stylesheet">
...
<body>
    ...
    <div class="centered-content">
        ...
        <div class="formcard" id="formcard">
            ...
            <form method="POST" action="<?php echo e(route('loginuser')); ?>" class="input-form needs-validation mt-5" id="login-form">
                <?php echo csrf_field(); ?>
    ...
    <script src="<?php echo e(asset('assets/js/loginregister.js')); ?>"></script>
...
<?php /**PATH C:\xampp\htdocs\main_finalproject\resources\views/registernewuser.blade.php ENDPATH**/ ?>