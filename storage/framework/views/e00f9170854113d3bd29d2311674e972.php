...
<body class="body">
    ...
    <nav class="navbar  navbar-expand-lg">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse d-flex">
                ...
                <a class="col navbar-brand justify-content-center align-content-center text-center m-0" href="<?php echo e(url('home')); ?>">
                ...
                <div class="col navbar-nav d-flex justify-content-center align-content-center">
                    <a class="nav-link navBtn w-75 text-center" href="<?php echo e(route('newBook')); ?>"><i class="fa-solid fa-circle-plus"></i> Add Recipe</a>
                    <!-- <a class="nav-link navBtn d-flex justify-content-center p-2" href="<?php echo e(url('favorites')); ?>"><i class="fa-solid fa-bookmark navBtn Icon"></i>Favorites</a> -->
                </div>
                ...
                <div class="col navbar-nav d-flex justify-content-center align-content-center">
                    <!-- <a class="nav-link navBtn" href="<?php echo e(route('newBook')); ?>">+ Add Recipe</a> -->
                    <a class="nav-link navBtn d-flex justify-content-center align-content-center p-2 w-75" href="<?php echo e(url('favorites')); ?>"><i class="fa-solid fa-bookmark navBtn Icon"></i>Favorites</a>
                </div>
                ...
                <div class="col navbar-nav ms-auto justify-content-center align-content-center">
                    <li class="nav-item dropdown w-75">
                        <a class="nav-link dropdown-toggle text-center" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            <?php echo e($get_userName); ?> - <?php echo e($userType); ?>
    ...
    <div class="main d-flex">
        <div class="col-1">
            <aside class="sidebar">
                <ul>
                    <li class="<?php echo e(request()->is('home/tables/*') ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('home.tables.overview')); ?>"><i class="fa-solid fa-table Icon me-2"></i>Table</a>
                    </li>
                    <li class="<?php echo e(request()->is('home/admin') ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('home.admin')); ?>"><i class="fa-solid fa-house Icon me-2"></i>Home</a>
                    </li>
                    <li class="<?php echo e(request()->is('home/settings') ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('home.settings')); ?>"><i class="fa-solid fa-gear Icon me-2"></i>Settings</a>
                    </li>
                </ul>
            </aside>
        </div>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            searchForm.addEventListener('submit', e => {
                ...
                if (pathname.includes('home/tables')) {
                    ...
                    searchForm.action = "<?php echo e(url('home/admin')); ?>"
                }
                // alert('called');
            });
...
</html><?php /**PATH C:\xampp\htdocs\main_finalproject\resources\views/admin_dashboard.blade.php ENDPATH**/ ?>