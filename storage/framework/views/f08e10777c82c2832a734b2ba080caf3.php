        ...
        <div class="container-top-nav container-fluid">
            <div class="left-brand-container">
                <a class="navbar-brand" href="<?php echo e(url('home')); ?>">
                    <img src="<?php echo e(asset('assets/favicon_io/chefshat.svg')); ?>" alt="" srcset="" class="Icon-web" width="32" height="32">
    ...
    <div class="main">
        <div class="column left">
            ...
            <div class="container-form">
                <form action="<?php echo e(route('newBook.create')); ?>" method="POST" enctype="multipart/form-data" id="myForm">
                    <?php echo csrf_field(); ?>
                    <input name="userId" value="<?php echo e($get_userId); ?>" class="d-none">
                    
                    <div class="required">
                        <input name="recipeTitle" type="text" class="input-field-title" id="sourceInput" placeholder="Title" value="<?php echo e(old('recipeTitle')); ?>" required>
                    </div>
                    ...
                    <div class="mt-3">
                        <textarea name="recipeIngridients" class="input-field-big" placeholder="Ingredients..." ><?php echo e(old('recipeIngridients')); ?></textarea>
                    </div>
                    
                    <div class="mt-3">
                        <textarea name="recipeDescription" class="input-field-big" placeholder="Description/Instructions..." ><?php echo e(old('recipeDescription')); ?></textarea>
                    </div>

                    <div class="">
                        <label for="sourceInput" class="form-label mb-0">Recipe Origin</label>
                        <input name="recipeOrigin" type="text" class="input-field-category" id="sourceInput" placeholder="Recipe Origin"  value="<?php echo e(old('recipeOrigin')); ?>">
                    </div>
                    ...
                    <div class="container-User justify-content-center align-items-center navBarActions_dropdown">
                        <div class="item book-item">
                            <img class="coverImg" id="imagePreview" src="<?php echo e(asset('assets/Images/default.jpg')); ?>" alt="Cover Image">
                    ...
                    <div class="d-flex justify-content-between">
                            <a type="cancel" class="btnCancel mt-3 text-decoration-none" href="<?php echo e(url('home')); ?>">Cancel</a>
        ...
        <div class="column right hide-at-small-screen">
            ...
            <div class="container-User d-flex justify-content-center align-items-center">
                <div class="item book-item">
                    <img class="coverImg" id="imagePreviewRS" src="<?php echo e(asset('assets/Images/default.jpg')); ?>" alt="Cover Image">
                    <div class="info">
                        <a class="title" id="targetInput">Title</a>
                        <a class="byText">By</a>
                        <p class="author d-inline"><?php echo e($get_userName); ?></p>
...
</html><?php /**PATH C:\xampp\htdocs\main_finalproject\resources\views//newBook.blade.php ENDPATH**/ ?>